# Anna-Maria Reim - QA Engineer (Manual + API)
...
<ul>
  <li><a href="https://github.com/">Webshop Testing</a> – exploratory and functional testing</li>
  ...
  <li><a href="https://github.com/">Bash</a> – scripts for QA tasks</li>
  <li><a href="https://github.com/">Git</a> – basic version control commands</li>
</ul>

## 🎯 Goals & Interests

- Deepen expertise in test automation (starting with API → UI)
- Improve communication in English for international collaboration
- Contribute to high-quality, user-friendly software

*🎲 Beyond testing, you’ll find me immersed in board games, computer adventures, brain-teasing quizzes, and immersive quests — because solving puzzles never really ends!😊*
